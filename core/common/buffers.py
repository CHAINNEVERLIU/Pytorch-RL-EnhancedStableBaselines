...
from core.common.preprocessing import get_action_dim, get_obs_shape
from core.common.type_aliases import (
...
from core.common.vec_env import VecNormalize
...
class BaseBuffer(ABC):
    ...
    def to_torch(self, array: np.ndarray, copy: bool = True) -> th.Tensor:
        ...
        return th.as_tensor(array, device=self.device, dtype=th.float32)
