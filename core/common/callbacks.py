...
from core.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization

if TYPE_CHECKING:
    from core.common import base_class
...
class BaseCallback(ABC):
    ...
    # Type hint as string to avoid circular import
    def init_callback(self, model: Union["base_class.BaseAlgorithm", "base_class.MultiAgentBaseAlgorithm"]) -> None:
        """
