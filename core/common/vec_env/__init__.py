...
from core.common.vec_env.base_vec_env import CloudpickleWrapper, VecEnv, VecEnvWrapper
from core.common.vec_env.dummy_vec_env import DummyVecEnv
from core.common.vec_env.stacked_observations import StackedObservations
from core.common.vec_env.subproc_vec_env import SubprocVecEnv
from core.common.vec_env.vec_check_nan import VecCheckNan
from core.common.vec_env.vec_extract_dict_obs import VecExtractDictObs
from core.common.vec_env.vec_frame_stack import VecFrameStack
from core.common.vec_env.vec_monitor import VecMonitor
from core.common.vec_env.vec_normalize import VecNormalize
from core.common.vec_env.vec_transpose import VecTransposeImage
from core.common.vec_env.vec_video_recorder import VecVideoRecorder
...
def unwrap_vec_wrapper(env: VecEnv, vec_wrapper_class: type[VecEnvWrapperT]) -> Optional[VecEnvWrapperT]:
    """
    递归解开 VecEnvWrapper，找到目标 Wrapper。
...
def unwrap_vec_normalize(env: VecEnv) -> Optional[VecNormalize]:
    """
    检查 VecEnv 是否被 VecNormalize 包装，并返回该 Wrapper。
